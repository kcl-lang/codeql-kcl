...
//  private final List<Comment> comments;
    ...
    public LexicalExtractor(TextualExtractor textualExtractor) {
...
//  }
    ...
    public ParseResultInfo extractLines(String src, Label toplevelKey) {
        textualExtractor.getMetrics().startPhase(ExtractionMetrics.ExtractionPhase.LexicalExtractor_extractLines);
        ...
        textualExtractor.getMetrics().stopPhase(ExtractionMetrics.ExtractionPhase.LexicalExtractor_extractLines);
        return info;
    }
